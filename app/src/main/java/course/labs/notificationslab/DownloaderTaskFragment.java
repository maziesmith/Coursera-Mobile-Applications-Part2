...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> arrayList = getArguments().getIntegerArrayList("friends");

        // TODO: Start the DownloaderTask
        dt.execute(arrayList.toArray(new Integer[arrayList.size()]));
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (getResultCode() != MainActivity.IS_ALIVE) {
                                ...
                                notificationBuilder.setAutoCancel(true).setSmallIcon(android.R.drawable.stat_sys_warning);
                                notificationBuilder.setContent(mContentView).setContentIntent(mContentIntent);
